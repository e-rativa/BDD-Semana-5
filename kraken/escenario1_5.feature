Feature: Shared board connection
  ...
  @user1 @web
  Scenario: Login
    Given I navigate to page "http://3b429be77858.ngrok.io/ghost/#/signin"
    ...
    Then I navigate to page "http://3b429be77858.ngrok.io/ghost/#/signin"
    ...
    Then I click on element having id "ember12"
    Then I navigate to page "http://3b429be77858.ngrok.io/ghost/#/signout"
  ...
  Scenario: Login-Crear post
    ...
    Then I enter "qwerty1234" into input field having id "ember10"
    Then I click on element having id "ember12"
    Then I navigate to page "http://3b429be77858.ngrok.io/ghost/#/editor/post"
