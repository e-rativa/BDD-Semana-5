...
| **Escenarios** | **Caso de Prueba 1**                     | **Caso de Prueba 2**                       | **Caso de Prueba 3**                             | **Caso de Prueba 4**              | **Caso de Prueba 5**                                         |
| -------------- | ---------------------------------------- | ------------------------------------------ | ------------------------------------------------ | --------------------------------- | ------------------------------------------------------------ |
| Escenario 1    | Comprobacion de datos vacios             | Datos Erroneos                             | Datos Correctos                                  |                                   |                                                              |
| Escenario 2    | Recuperar la contraseña con datos vacíos | Recuperar la contraseña con datos erróneos | Recuperar la contraseña con datos válidos        |                                   |                                                              |
| Escenario 3    | Login con datos correctos                | Llenar post con título                     | Llenar post con contenido                        | Publicar un post inmediatamente   |                                                              |
| Escenario 4    | Login con datos correctos                | Crear un post completo                     | Publicar un post agendado                        |                                   |                                                              |
| Escenario 5    | Login con datos correctos                | Crear un post completo                     | Ponerle url personalizada                        | Resaltar el post                  | Publicar el post                                             |
| Escenario 6    | Login con datos correctos                | Crear una página sin título                | Crear una página sin descripción                 | Crear una página completa         |                                                              |
| Escenario 7    | Login con datos correctos                | Crear página completa                      | Publicar un página inmediatamente                |                                   |                                                              |
| Escenario 8    | Login con datos correctos                | Crear página completa                      | Publicar un página agenda                        |                                   |                                                              |
| Escenario 9    | Login con datos correctos                | Crear un tag sin título                    |                                                  |                                   |                                                              |
| Escenario 10   | Login con datos correctos                | Crear un tag con título y descripción      |                                                  |                                   |                                                              |
| Escenario 11   | Login con datos correctos                | Creación de un usuario como administrador  | Creación de un usuario como editor               | Creación de un usuario como autor | Creación de un usuario como contribuidor                     |
| Escenario 12   | Login con datos correctos                | Creación de un usuario como administrador  | Revocar invitación de usuario                    |                                   |                                                              |
| Escenario 13   | Login con datos correctos                | Creación de un usuario como administrador  | Cambiar nombre y rol del usuario                 |                                   |                                                              |
| Escenario 14   | Login con datos correctos                | Creación de un usuario como administrador  | Cambiar la contraseña con contraseñas diferentes |                                   |                                                              |
| Escenario 15   | Login con datos correctos                | Creación de un usuario como administrador  | Cambiar la contraseña con contraseñas iguales    |                                   |                                                              |
| Escenario 16   | Login con datos correctos                | Ir a la pagina de SETTINGS                 | Editar el nombre de la página web                | Guardar cambios                   |                                                              |
| Escenario 17   | Login con datos correctos                | Ir a la pagina de SETTINGS                 | Activar la página como un sitio privado          | Guardar cambios                   |                                                              |
| Escenario 18   | Login con datos correctos                | Ir a la pagina de DESIGN                   | Cambiar el nombre de la página de home           | Guardar cambios                   | Ir a la pagina principal, verificar cambio de nombre de HOME |
| Escenario 19   | Login con datos correctos                | Ir a las opciones MORE                     | Ir a las opciones LABS                           | Habilitar miembros                | Ir a la pagina de MEMBERS                                    |
| Escenario 20   | Login con datos correctos                | Ir a las opciones MORE                     | Ir a opciones de perfil                          | Logout                            |                                                              |
